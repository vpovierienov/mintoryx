...
<section className="py-12 bg-gray-900 sm:py-16 lg:py-20">
  <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
    ...
    <div
      className="max-w-5xl mx-auto mt-8 space-y-6 sm:space-y-8 xl:space-y-12 sm:mt-12"
    >
      <div
        className="grid items-center grid-cols-1 sm:grid-cols-2 gap-y-6 sm:gap-y-8 md:grid-cols-4 place-items-center gap-x-8"
      >
        <img
